...
## Get Started
1. **Install [Node 6](https://nodejs.org)**. Need to run multiple versions of Node? Use [nvm](https://github.com/creationix/nvm)
2. **Clone this repository.** - or [download the zip]
3. **Make sure you're in the directory you just created.** - `cd yourprojectdirectory`
